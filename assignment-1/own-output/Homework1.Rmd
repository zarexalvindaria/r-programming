...
```{r}
# Create vector out of text elements
department <- c("MISM", "MSPPM","EPP")
department
```
...
```{r}
# Extact growth records of Tree number 4 using subset
Orange.subset <- subset(Orange, Tree == 4)
Orange.subset
...
```{r}
# Create a plot with circumference and age as the axis
plot(circumference ~ age, data = Orange, subset = Tree == 4,
     xlab = "Tree age",
     ylab = "Tree circumference (mm)", las = 1,
     main = "Orange tree data and fitted model (Tree 4 only)")
