...
#### Body
Now, to expound on the summary dataset, the Analytics Practitioner will answer the questions posed with the help of graphs and charts.
...
print(as_tibble(sd.class.lang), n=100)
```
...
class.iq + 
  stat_summary(fun = "mean", geom = "bar") +
    labs(
       x="class",
       y="IQ",
       title="Average Student IQ by Class", 
